...
094d: 08 07     or    a,#$07
094f: c4 f2     mov   $f2,a
0951: 8f 9e f3  mov   $f3,#$9e
0954: ae        pop   a
0955: 08 05     or    a,#$05
0957: c4 f2     mov   $f2,a
0959: 8f 00 f3  mov   $f3,#$00
095c: 1d        dec   x
095d: 10 eb     bpl   $094a
095f: 6f        ret
...
098f: c4 02     mov   $02,a
0991: f5 53 d3  mov   a,$d353+x
0994: c4 03     mov   $03,a
0996: 8d 00     mov   y,#$00
0998: cd 00     mov   x,#$00
099a: 8d 00     mov   y,#$00
099c: f7 02     mov   a,($02)+y
099e: c4 04     mov   $04,a
09a0: 3a 02     incw  $02
09a2: f7 02     mov   a,($02)+y
09a4: 68 ff     cmp   a,#$ff
09a6: f0 3c     beq   $09e4
09a8: c4 05     mov   $05,a
09aa: 3a 02     incw  $02
...
0db9: 08 07     or    a,#$07
0dbb: c4 f2     mov   $f2,a
0dbd: 8f 9e f3  mov   $f3,#$9e
0dc0: 1d        dec   x
0dc1: 10 f0     bpl   $0db3
0dc3: 6f        ret

0dc4: 8f 4d f2  mov   $f2,#$4d
0dc7: fa 33 f3  mov   ($f3),($33)
0dca: e4 40     mov   a,$40
0dcc: 48 ff     eor   a,#$ff
0dce: 24 3e     and   a,$3e
0dd0: 8d 4c     mov   y,#$4c
0dd2: 3f e5 1f  call  $1fe5
0dd5: e4 3f     mov   a,$3f
0dd7: 48 ff     eor   a,#$ff
0dd9: 24 3d     and   a,$3d
...
0feb: ce        pop   x
0fec: f5 32 21  mov   a,$2132+x
0fef: 04 34     or    a,$34
0ff1: c4 34     mov   $34,a
0ff3: 5f 47 0f  jmp   $0f47

0ff6: ce        pop   x
0ff7: f5 32 21  mov   a,$2132+x
0ffa: 48 ff     eor   a,#$ff
0ffc: 24 34     and   a,$34
0ffe: c4 34     mov   $34,a
...
143f: f5 32 21  mov   a,$2132+x
1442: 04 f3     or    a,$f3
1444: c4 f3     mov   $f3,a
1446: 5f 47 0f  jmp   $0f47

1449: ce        pop   x
144a: f5 32 21  mov   a,$2132+x
144d: 2d        push  a
144e: 04 31     or    a,$31
1450: c4 31     mov   $31,a
1452: ae        pop   a
...
1897: 04 00     or    a,$00
1899: c4 f2     mov   $f2,a
189b: fa 06 f3  mov   ($f3),($06)
189e: ab f2     inc   $f2
18a0: fa 07 f3  mov   ($f3),($07)
18a3: ee        pop   y
18a4: 6f        ret
...
1bdf: 3f 7d 1c  call  $1c7d
1be2: f7 00     mov   a,($00)+y
1be4: fc        inc   y
1be5: 2d        push  a
1be6: 3f 8a 1c  call  $1c8a
1be9: ae        pop   a
1bea: 6f        ret

1beb: 3f 7d 1c  call  $1c7d
...
1bfd: 3f 8a 1c  call  $1c8a
1c00: 1b 36     asl   $36+x
1c02: e8 00     mov   a,#$00
1c04: 88 03     adc   a,#$03
1c06: d4 06     mov   $06+x,a
1c08: e8 ff     mov   a,#$ff
1c0a: d4 26     mov   $26+x,a
1c0c: 9b 16     dec   $16+x
1c0e: 6f        ret

1c0f: 3f 7d 1c  call  $1c7d
...
1f66: 8f 20 f3  mov   $f3,#$20
1f69: 8f 7d f2  mov   $f2,#$7d
1f6c: c4 f3     mov   $f3,a
1f6e: 8f 6d f2  mov   $f2,#$6d
1f71: 8f f8 f3  mov   $f3,#$f8

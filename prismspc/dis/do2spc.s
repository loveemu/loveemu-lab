...
0a39: c4 00     mov   $00,a             ; 00 - channel index
0a3b: fc        inc   y
0a3c: f7 06     mov   a,($06)+y
0a3e: c4 01     mov   $01,a             ; 01 - ?
0a40: fc        inc   y
...
0b05: e8 9f     mov   a,#$9f
0b07: d5 e0 03  mov   $03e0+x,a
0b0a: e4 04     mov   a,$04
0b0c: d5 60 05  mov   $0560+x,a
0b0f: e8 0a     mov   a,#$0a
0b11: d5 d8 05  mov   $05d8+x,a
0b14: e8 b6     mov   a,#$b6
0b16: d5 f0 05  mov   $05f0+x,a
0b19: e8 14     mov   a,#$14
0b1b: d5 08 06  mov   $0608+x,a         ; $14b6
0b1e: 6f        ret

0b1f: 8f 17 24  mov   $24,#$17
0b22: f8 24     mov   x,$24
...
0bab: 28 1f     and   a,#$1f
0bad: c4 01     mov   $01,a
0baf: f5 60 05  mov   a,$0560+x
0bb2: c4 04     mov   $04,a
0bb4: f5 d8 05  mov   a,$05d8+x
0bb7: c4 05     mov   $05,a
0bb9: 3f a1 0a  call  $0aa1
0bbc: 8d 00     mov   y,#$00
0bbe: f8 24     mov   x,$24
...
0bc5: e4 00     mov   a,$00
0bc7: 60        clrc
0bc8: 95 60 02  adc   a,$0260+x
0bcb: d5 a8 02  mov   $02a8+x,a
0bce: f5 78 02  mov   a,$0278+x
0bd1: d5 90 02  mov   $0290+x,a
0bd4: e8 ff     mov   a,#$ff
0bd6: d5 c0 02  mov   $02c0+x,a
0bd9: 3a 26     incw  $26
0bdb: f8 24     mov   x,$24
0bdd: 8d 00     mov   y,#$00
0bdf: 3f e7 13  call  $13e7
0be2: 3f f9 13  call  $13f9
0be5: 3f 17 14  call  $1417
0be8: f8 24     mov   x,$24
0bea: e4 26     mov   a,$26
0bec: d5 30 02  mov   $0230+x,a
0bef: e4 27     mov   a,$27
0bf1: d5 48 02  mov   $0248+x,a
0bf4: e4 28     mov   a,$28
0bf6: 28 20     and   a,#$20
0bf8: d0 30     bne   $0c2a
0bfa: 18 02 28  or    $28,#$02
0bfd: f5 b0 03  mov   a,$03b0+x
0c00: 08 80     or    a,#$80
0c02: d5 b0 03  mov   $03b0+x,a
0c05: e4 28     mov   a,$28
0c07: 28 80     and   a,#$80
0c09: f0 09     beq   $0c14
0c0b: f5 40 04  mov   a,$0440+x
0c0e: d5 f8 03  mov   $03f8+x,a
0c11: f5 58 04  mov   a,$0458+x
0c14: d5 10 04  mov   $0410+x,a
0c17: e8 00     mov   a,#$00
0c19: d5 28 04  mov   $0428+x,a
0c1c: e8 01     mov   a,#$01
...
0c48: d0 1f     bne   $0c69
0c4a: fd        mov   y,a
0c4b: f5 20 06  mov   a,$0620+x
0c4e: da 26     movw  $26,ya
0c50: f5 50 06  mov   a,$0650+x
0c53: fd        mov   y,a
0c54: f7 26     mov   a,($26)+y
0c56: 10 05     bpl   $0c5d
0c58: fc        inc   y
...
0c64: f5 68 06  mov   a,$0668+x
0c67: d4 a2     mov   $a2+x,a
0c69: f5 60 05  mov   a,$0560+x
0c6c: c4 2b     mov   $2b,a
...
0e46: e8 00     mov   a,#$00
0e48: c4 39     mov   $39,a
0e4a: f5 b0 03  mov   a,$03b0+x
0e4d: c4 43     mov   $43,a
0e4f: f5 c8 03  mov   a,$03c8+x
0e52: c4 44     mov   $44,a
0e54: f5 e0 03  mov   a,$03e0+x
0e57: c4 45     mov   $45,a
...
0e63: c4 45     mov   $45,a
0e65: 38 7f 43  and   $43,#$7f
0e68: e8 00     mov   a,#$00
0e6a: d5 10 04  mov   $0410+x,a
0e6d: 2f 4b     bra   $0eba
...
0e7f: d5 10 04  mov   $0410+x,a
0e82: e8 00     mov   a,#$00
0e84: d5 28 04  mov   $0428+x,a
0e87: e8 01     mov   a,#$01
0e89: d4 72     mov   $72+x,a
0e8b: f5 10 04  mov   a,$0410+x
0e8e: f0 2a     beq   $0eba
0e90: 9b 72     dec   $72+x
0e92: d0 26     bne   $0eba
0e94: c4 27     mov   $27,a
0e96: f5 f8 03  mov   a,$03f8+x
0e99: c4 26     mov   $26,a
0e9b: f5 28 04  mov   a,$0428+x
0e9e: fd        mov   y,a
0e9f: f7 26     mov   a,($26)+y
0ea1: 68 ff     cmp   a,#$ff
0ea3: d0 06     bne   $0eab
0ea5: fc        inc   y
0ea6: f7 26     mov   a,($26)+y
0ea8: fd        mov   y,a
0ea9: 2f f4     bra   $0e9f
0eab: c4 45     mov   $45,a
0ead: fc        inc   y
0eae: f7 26     mov   a,($26)+y
0eb0: d4 72     mov   $72+x,a
0eb2: fc        inc   y
0eb3: dd        mov   a,y
0eb4: d5 28 04  mov   $0428+x,a
0eb7: 38 7f 43  and   $43,#$7f
0eba: e4 43     mov   a,$43
0ebc: d5 b0 03  mov   $03b0+x,a
0ebf: e4 44     mov   a,$44
0ec1: d5 c8 03  mov   $03c8+x,a
0ec4: e4 45     mov   a,$45
0ec6: d5 e0 03  mov   $03e0+x,a
0ec9: e4 3d     mov   a,$3d
0ecb: 08 07     or    a,#$07
0ecd: c4 f2     mov   $f2,a
...
; vcmd dispatch table
0eff: dw $0f7f  ; c0 - set timer 0 freq
0f01: dw $0f7f  ; c1 - set timer 0 freq
0f03: dw $0f7f  ; c2 - set timer 0 freq
0f05: dw $0f7f  ; c3 - set timer 0 freq
0f07: dw $0f7f  ; c4 - set timer 0 freq
0f09: dw $0f88  ; c5 - conditional jump (flag)
0f0b: dw $0f96  ; c6 - set condition (flag)
0f0d: dw $0f9c  ; c7 - unknown.1
0f0f: dw $0fa8  ; c8 - unknown.2
0f11: dw $0fbd  ; c9 - unknown.2
0f13: dw $0fd2  ; ca - unknown.0 (echo params)
0f15: dw $0ff1  ; cb - unknown.0 (echo params)
0f17: dw $1006  ; cc - set master volume
0f19: dw $100f  ; cd - unknown.0 (on/off switch)
0f1b: dw $1015  ; ce - unknown.0 (on/off switch)
0f1d: dw $101e  ; cf - unknown.2
0f1f: dw $1035  ; d0 - unknown.0 (use preset)
0f21: dw $1044  ; d1 - unknown.0 (use preset)
0f23: dw $1053  ; d2 - unknown.0 (on/off switch)
0f25: dw $1059  ; d3 - unknown.0 (increment)
0f27: dw $105e  ; d4 - unknown.0 (increment)
0f29: dw $1063  ; d5 - unknown.1
0f2b: dw $106c  ; d6 - unknown.1
0f2d: dw $1075  ; d7 - unknown.1
0f2f: dw $107e  ; d8 - unknown.1
0f31: dw $108e  ; d9 - unknown.3
0f33: dw $10b1  ; da - unknown.2 (set table address)
0f35: dw $10c4  ; db - nop.2
0f37: dw $10cb  ; dc - unknown.0 (zero variable)
0f39: dw $10d5  ; dd - unknown.1 (set variable)
...
0f45: dw $1177  ; e3 - unknown.1
0f47: dw $1183  ; e4 - unknown.1
0f49: dw $118f  ; e5 - unknown.1
0f4b: dw $119e  ; e6 - unknown.0
0f4d: dw $11a4  ; e7 - unknown.3
0f4f: dw $11c1  ; e8 - unknown.1
0f51: dw $11d2  ; e9 - unknown.2
0f53: dw $11fc  ; ea - unknown.1
0f55: dw $1228  ; eb - unknown.1
0f57: dw $1239  ; ec - unknown.1
0f59: dw $124a  ; ed - unknown.3
0f5b: dw $126f  ; ee - unknown.x (variable length)
0f5d: dw $1292  ; ef - unknown.2
0f5f: dw $12a5  ; f0 - unknown.2
0f61: dw $12ba  ; f1 - unknown.0 (on/off switch)
0f63: dw $12c0  ; f2 - unknown.0 (on/off switch)
0f65: dw $12c6  ; f3 - unknown.1
0f67: dw $12d5  ; f4 - unknown.0 (on/off switch)
0f69: dw $12db  ; f5 - unknown.0 (on/off switch)
0f6b: dw $12e1  ; f6 - unknown.2
0f6d: dw $12f4  ; f7 - unknown.2
0f6f: dw $1309  ; f8 - unknown.3
0f71: dw $1324  ; f9 - unknown.0 (on/off switch)
0f73: dw $132a  ; fa - unknown.0 (on/off switch)
0f75: dw $1330  ; fb - unknown.4
0f77: dw $135d  ; fc - unknown.x (variable length)
0f79: dw $138d  ; fd - unknown.2
0f7b: dw $13a3  ; fe - unknown.1
0f7d: dw $13c2  ; ff - unknown.0

; vcmd c0-c4 - set timer 0 freq
...
104b: e8 14     mov   a,#$14
104d: d5 08 06  mov   $0608+x,a         ; $14b6
...
1092: d5 20 06  mov   $0620+x,a
1095: 3a 26     incw  $26
1097: f7 26     mov   a,($26)+y
1099: d5 38 06  mov   $0638+x,a
109c: 3a 26     incw  $26
109e: f7 26     mov   a,($26)+y
10a0: d5 68 06  mov   $0668+x,a
10a3: e8 01     mov   a,#$01
...
11a8: d5 38 03  mov   $0338+x,a
11ab: 3a 26     incw  $26
11ad: f7 26     mov   a,($26)+y
11af: d5 f0 02  mov   $02f0+x,a
11b2: 3a 26     incw  $26
11b4: f7 26     mov   a,($26)+y
11b6: d5 08 03  mov   $0308+x,a
11b9: 3a 26     incw  $26
11bb: 18 04 28  or    $28,#$04
...
;
1213: 60        clrc
1214: 95 60 05  adc   a,$0560+x
1217: 90 02     bcc   $121b
1219: e8 ff     mov   a,#$ff
;
121b: d5 60 05  mov   $0560+x,a
121e: 3a 26     incw  $26
1220: e8 00     mov   a,#$00
...
122c: d5 d8 05  mov   $05d8+x,a
122f: 3a 26     incw  $26
1231: e8 00     mov   a,#$00
1233: d5 38 06  mov   $0638+x,a
1236: 5f 5d 0b  jmp   $0b5d

; vcmd ec
1239: f8 24     mov   x,$24
123b: f7 26     mov   a,($26)+y
123d: d5 60 05  mov   $0560+x,a
1240: 3a 26     incw  $26
1242: e8 00     mov   a,#$00
...
; vcmd ee
126f: f8 24     mov   x,$24
1271: 3f e7 13  call  $13e7
1274: 3f 17 14  call  $1417
1277: f5 d0 04  mov   a,$04d0+x
127a: d5 f8 03  mov   $03f8+x,a
127d: f5 e8 04  mov   a,$04e8+x
1280: d5 10 04  mov   $0410+x,a
1283: e8 00     mov   a,#$00
1285: d5 28 04  mov   $0428+x,a
1288: e8 01     mov   a,#$01
128a: d4 72     mov   $72+x,a
128c: 18 20 28  or    $28,#$20
...
12a9: d5 80 03  mov   $0380+x,a
12ac: 3a 26     incw  $26
12ae: f7 26     mov   a,($26)+y
12b0: 08 80     or    a,#$80
12b2: d5 98 03  mov   $0398+x,a
12b5: 3a 26     incw  $26
...
1317: c4 4e     mov   $4e,a
1319: 3a 26     incw  $26
131b: 3f 62 14  call  $1462
131e: 8f 00 51  mov   $51,#$00
...
1354: 3f 62 14  call  $1462
1357: 8f 00 51  mov   $51,#$00
...
1361: 10 12     bpl   $1375
1363: d5 b0 03  mov   $03b0+x,a
1366: 3a 26     incw  $26
1368: f7 26     mov   a,($26)+y
136a: d5 c8 03  mov   $03c8+x,a
136d: 3a 26     incw  $26
136f: 38 7f 28  and   $28,#$7f
1372: 5f 5d 0b  jmp   $0b5d
1375: 3a 26     incw  $26
1377: f5 50 03  mov   a,$0350+x
137a: fd        mov   y,a
137b: f6 00 1f  mov   a,$1f00+y
137e: d5 b0 03  mov   $03b0+x,a
1381: f6 00 20  mov   a,$2000+y
1384: d5 c8 03  mov   $03c8+x,a
1387: 38 7f 28  and   $28,#$7f
...
13a7: 3a 26     incw  $26
13a9: d5 50 03  mov   $0350+x,a
13ac: fd        mov   y,a
13ad: f6 00 1f  mov   a,$1f00+y
13b0: d5 b0 03  mov   $03b0+x,a
13b3: f6 00 20  mov   a,$2000+y
13b6: d5 c8 03  mov   $03c8+x,a
13b9: 38 7f 28  and   $28,#$7f
...
13e7: f5 00 05  mov   a,$0500+x
13ea: d0 04     bne   $13f0
13ec: f7 26     mov   a,($26)+y
13ee: 3a 26     incw  $26
13f0: d4 5a     mov   $5a+x,a
13f2: f5 80 03  mov   a,$0380+x
13f5: d5 68 03  mov   $0368+x,a
13f8: 6f        ret
...
140e: 90 03     bcc   $1413
1410: f5 b8 04  mov   a,$04b8+x
1413: d5 a0 04  mov   $04a0+x,a
1416: 6f        ret

1417: e4 28     mov   a,$28
1419: 28 01     and   a,#$01
141b: d0 12     bne   $142f
141d: f7 26     mov   a,($26)+y
141f: 68 ee     cmp   a,#$ee
1421: f0 0c     beq   $142f
1423: 68 f4     cmp   a,#$f4
1425: f0 08     beq   $142f
...
142d: d0 08     bne   $1437
142f: e8 00     mov   a,#$00
1431: d5 a0 04  mov   $04a0+x,a
1434: d5 68 03  mov   $0368+x,a
1437: 6f        ret
...
148a: e4 1b     mov   a,$1b
148c: f0 03     beq   $1491
148e: 8f 0a 2c  mov   $2c,#$0a
1491: e8 14     mov   a,#$14
1493: 80        setc
1494: a4 2c     sbc   a,$2c
1496: fd        mov   y,a
1497: f7 2d     mov   a,($2d)+y
1499: c4 00     mov   $00,a
149b: eb 2c     mov   y,$2c
...
153d: db $39,$49,$59,$69,$79,$89,$99,$a9
1545: db $b9,$08,$18,$28,$38,$48,$58,$68
154d: db $78,$88,$98,$a8,$b8,$07,$17,$27
1555: db $37,$47,$57,$67,$77,$87,$97,$a7
155d: db $b7,$06,$16,$26,$36,$46,$56,$66
1565: db $76,$86,$96,$a6,$b6,$05,$15,$25
156d: db $35,$45,$55,$65,$75,$85,$95,$a5
1575: db $b5,$04,$14,$24,$34,$44,$54,$64
157d: db $74,$84,$94,$a4,$b4,$03,$13,$23
1585: db $33,$43,$53,$63,$73,$83,$93,$a3
158d: db $b3,$02,$12,$22,$32,$42,$52,$62
1595: db $72,$82,$92,$a2,$b2,$01,$11,$21
159d: db $31,$41,$51,$61,$71,$81,$91,$a1
15a5: db $b1,$00,$10,$20,$30,$40,$50,$60
15ad: db $70,$80,$90,$a0,$b0,$00,$10,$20
...
1769: 3f 62 14  call  $1462
176c: 6f        ret

176d: 8f ff 1b  mov   $1b,#$ff
1770: 3f 62 14  call  $1462
1773: 6f        ret

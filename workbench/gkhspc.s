...
f422: 80        setc
f423: a8 50     sbc   a,#$50
f425: 3f 21 f5  call  $f521
f428: 2f d6     bra   $f400
f42a: 80        setc
f42b: a8 60     sbc   a,#$60
f42d: 3f 55 f6  call  $f655
f430: 2f ce     bra   $f400
f432: 80        setc
f433: a8 40     sbc   a,#$40
f435: 3f 88 f6  call  $f688
f438: 2f c6     bra   $f400
f43a: 80        setc
f43b: a8 48     sbc   a,#$48
f43d: 3f 8f f6  call  $f68f
f440: 2f be     bra   $f400
...
f468: 68 f5     cmp   a,#$f5
f46a: 2d        push  a
f46b: f5 13 f5  mov   a,$f513+x
f46e: 31        tcall 3
f46f: f5 38 f5  mov   a,$f538+x
f472: c4 f4     mov   $f4,a
f474: d1        tcall 13
f475: f4 3f     mov   a,$3f+x
f477: f5 55 f5  mov   a,$f555+x
f47a: a1        tcall 10
f47b: f6 92 f6  mov   a,$f692+y
f47e: cb f5     mov   $f5,y
f480: fa f5 24  mov   ($24),($f5)
f483: f6 bf f5  mov   a,$f5bf+y
f486: c0        di
f487: f5 c1 f5  mov   a,$f5c1+x
f48a: 94 f4     adc   a,$f4+x
f48c: 6c f5 c6  ror   $c6f5
f48f: f5 3f f6  mov   a,$f63f+x
f492: 20        clrp
f493: f5 e1 c4  mov   a,$c4e1+x
f496: e1        tcall 14
f497: 28 03     and   a,#$03
f499: f0 1d     beq   $f4b8
f49b: 9c        dec   a
...
f507: d0 05     bne   $f50e
f509: e1        tcall 14
f50a: 3f dc f4  call  $f4dc
f50d: 6f        ret

f50e: e1        tcall 14
f50f: 3f f0 f4  call  $f4f0
f512: 6f        ret

f513: e1        tcall 14
f514: d4 0f     mov   $0f+x,a
...
f52d: e1        tcall 14
f52e: d4 12     mov   $12+x,a
f530: 6f        ret

f531: bb 0d     inc   $0d+x
f533: e8 ff     mov   a,#$ff
f535: d4 11     mov   $11+x,a
f537: 6f        ret

f538: 9b 0d     dec   $0d+x
f53a: e8 ff     mov   a,#$ff
f53c: d4 11     mov   $11+x,a
f53e: 6f        ret
...
f5c6: e1        tcall 14
f5c7: c5 d0 01  mov   $01d0,a
f5ca: 6f        ret

f5cb: e1        tcall 14
f5cc: 8d 04     mov   y,#$04
f5ce: d7 df     mov   ($df)+y,a
f5d0: 8d 00     mov   y,#$00
f5d2: f4 00     mov   a,$00+x
f5d4: d7 df     mov   ($df)+y,a
f5d6: fc        inc   y
f5d7: f4 01     mov   a,$01+x
f5d9: d7 df     mov   ($df)+y,a
f5db: 8d 02     mov   y,#$02
f5dd: e8 00     mov   a,#$00
f5df: d7 df     mov   ($df)+y,a
f5e1: fc        inc   y
f5e2: d7 df     mov   ($df)+y,a
f5e4: 3f e8 f5  call  $f5e8
f5e7: 6f        ret
...
f5fa: 3f f1 f5  call  $f5f1
f5fd: 8d 04     mov   y,#$04
f5ff: f7 df     mov   a,($df)+y
f601: 68 ff     cmp   a,#$ff
f603: f0 05     beq   $f60a
f605: 9c        dec   a
f606: f0 1b     beq   $f623
f608: d7 df     mov   ($df)+y,a
f60a: 8d 02     mov   y,#$02
f60c: f4 00     mov   a,$00+x
f60e: d7 df     mov   ($df)+y,a
f610: fc        inc   y
f611: f4 01     mov   a,$01+x
f613: d7 df     mov   ($df)+y,a
f615: 8d 00     mov   y,#$00
f617: f7 df     mov   a,($df)+y
f619: d4 00     mov   $00+x,a
f61b: fc        inc   y
f61c: f7 df     mov   a,($df)+y
f61e: d4 01     mov   $01+x,a
f620: 3f e8 f5  call  $f5e8
f623: 6f        ret

f624: 3f f1 f5  call  $f5f1
f627: 8d 04     mov   y,#$04
f629: f7 df     mov   a,($df)+y
f62b: 68 01     cmp   a,#$01
f62d: f0 04     beq   $f633
f62f: 3f e8 f5  call  $f5e8
f632: 6f        ret
...
f688: d4 0d     mov   $0d+x,a
f68a: e8 ff     mov   a,#$ff
f68c: d4 11     mov   $11+x,a
f68e: 6f        ret
...
f6c4: d0 03     bne   $f6c9
f6c6: e1        tcall 14
f6c7: d4 0b     mov   $0b+x,a
f6c9: 3f 47 f7  call  $f747
...
f6db: f0 07     beq   $f6e4
f6dd: e4 e1     mov   a,$e1
f6df: 74 11     cmp   a,$11+x
f6e1: d0 01     bne   $f6e4
f6e3: 6f        ret

f6e4: e4 e1     mov   a,$e1
f6e6: d4 11     mov   $11+x,a
f6e8: 3f 63 f7  call  $f763
f6eb: 3f 86 f7  call  $f786
f6ee: e4 e1     mov   a,$e1
f6f0: d4 04     mov   $04+x,a
f6f2: e4 e2     mov   a,$e2
f6f4: d4 05     mov   $05+x,a
f6f6: 3f 4c f8  call  $f84c
f6f9: e8 01     mov   a,#$01
...
f747: f4 0b     mov   a,$0b+x
f749: d4 09     mov   $09+x,a
f74b: fb 0c     mov   y,$0c+x
f74d: d0 05     bne   $f754
f74f: e8 00     mov   a,#$00
f751: d4 0a     mov   $0a+x,a
f753: 6f        ret
...
f75c: bc        inc   a
f75d: 60        clrc
f75e: 94 09     adc   a,$09+x
f760: d4 0a     mov   $0a+x,a
f762: 6f        ret

f763: 8f 00 e4  mov   $e4,#$00
f766: fb 12     mov   y,$12+x
f768: 30 0e     bmi   $f778
f76a: 60        clrc
...
f7c7: f6 60 f0  mov   a,$f060+y
f7ca: ad 10     cmp   y,#$10
f7cc: 90 01     bcc   $f7cf
f7ce: dd        mov   a,y
f7cf: ec d6 01  mov   y,$01d6
...
f7e3: c4 e1     mov   $e1,a
f7e5: c4 e2     mov   $e2,a
f7e7: f4 0f     mov   a,$0f+x
f7e9: 2d        push  a
f7ea: e5 d7 01  mov   a,$01d7
...
f7fb: b0 0b     bcs   $f808
f7fd: 60        clrc
f7fe: 94 0f     adc   a,$0f+x
f800: 68 40     cmp   a,#$40
f802: 90 0d     bcc   $f811
f804: e8 00     mov   a,#$00
f806: 2f 09     bra   $f811
f808: 60        clrc
f809: 94 0f     adc   a,$0f+x
f80b: 68 81     cmp   a,#$81
f80d: 90 02     bcc   $f811
f80f: e8 80     mov   a,#$80
f811: d4 0f     mov   $0f+x,a
f813: e8 80     mov   a,#$80
f815: 80        setc
...
f881: e8 ff     mov   a,#$ff
f883: d4 11     mov   $11+x,a
f885: e8 ff     mov   a,#$ff
f887: d4 0a     mov   $0a+x,a
f889: 6f        ret
...
f8e5: fc        inc   y
f8e6: f7 d9     mov   a,($d9)+y
f8e8: c5 dc 01  mov   $01dc,a
f8eb: fc        inc   y
f8ec: f7 d9     mov   a,($d9)+y
f8ee: c5 dd 01  mov   $01dd,a
f8f1: fc        inc   y
f8f2: f7 d9     mov   a,($d9)+y
f8f4: c5 de 01  mov   $01de,a
f8f7: fc        inc   y
f8f8: cd 00     mov   x,#$00
f8fa: f7 d9     mov   a,($d9)+y
...
f903: d0 f5     bne   $f8fa
f905: 8d 06     mov   y,#$06
f907: f7 d9     mov   a,($d9)+y
f909: 3f dc f4  call  $f4dc
f90c: e8 00     mov   a,#$00
f90e: c5 c7 01  mov   $01c7,a
f911: c5 c8 01  mov   $01c8,a
f914: 8f 00 e5  mov   $e5,#$00
f917: 8f 08 e3  mov   $e3,#$08
f91a: 8d 10     mov   y,#$10
f91c: fc        inc   y
...
; tcall table
ffc0: dw $fe82  ; tcall 15
ffc2: dw $fa5f  ; tcall 14
ffc4: dw $fe82  ; tcall 13
ffc6: dw $fe82  ; tcall 12
ffc8: dw $fe82  ; tcall 11
ffca: dw $fe82  ; tcall 10
ffcc: dw $fe82  ; tcall 9
ffce: dw $fe82  ; tcall 8
ffd0: dw $ff3e  ; tcall 7
ffd2: dw $ff39  ; tcall 6
ffd4: dw $fe82  ; tcall 5
ffd6: dw $ff67  ; tcall 4
ffd8: dw $ff43  ; tcall 3
ffda: dw $ff98  ; tcall 2
ffdc: dw $ff75  ; tcall 1
ffde: dw $ff5c  ; tcall 0
